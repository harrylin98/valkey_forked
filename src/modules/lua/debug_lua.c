...
static void ldbEval(lua_State *lua, ValkeyModuleString **argv, int argc) {
    ...
    ValkeyModuleString *expr = ValkeyModule_CreateStringPrintf(NULL,
                                                               "return %s",
                                                               ValkeyModule_StringPtrLen(code, NULL));
...
void ldbGenerateDebuggerCommandsArray(lua_State *lua,
    ...
    if (commands_array_cache == NULL) {
        ValkeyModuleScriptingEngineDebuggerCommand commands_array[] = {
            VALKEYMODULE_SCRIPTING_ENGINE_DEBUGGER_COMMAND("step",
                                                           1,
                                                           NULL,
                                                           0,
                                                           "Run current line and stop again.",
                                                           0,
                                                           stepCommandHandler),
            VALKEYMODULE_SCRIPTING_ENGINE_DEBUGGER_COMMAND("next",
                                                           1,
                                                           NULL,
                                                           0,
                                                           "Alias for step.",
                                                           0,
                                                           stepCommandHandler),
            VALKEYMODULE_SCRIPTING_ENGINE_DEBUGGER_COMMAND("continue",
                                                           1,
                                                           NULL,
                                                           0,
            ...
            VALKEYMODULE_SCRIPTING_ENGINE_DEBUGGER_COMMAND(
                "list",
                1,
                list_params,
                2,
                "List source code around a specific line. If no line is specified the list is printed around the "
                "current line. [ctx] specifies how many lines to show before/after [line].",
                0,
                listCommandHandler),
            VALKEYMODULE_SCRIPTING_ENGINE_DEBUGGER_COMMAND("whole",
                                                           1,
                                                           NULL,
                                                           0,
                                                           "List all source code. Alias for 'list 1 1000000'.",
                                                           0,
                                                           wholeCommandHandler),
            VALKEYMODULE_SCRIPTING_ENGINE_DEBUGGER_COMMAND_WITH_CTX(
                "print",
                1,
                print_params,
                1,
                "Show the value of the specified variable [var]. Can also show global vars KEYS and ARGV. If no [var] "
                "is specidied, shows the value of all local variables.",
                0,
                printCommandHandler,
                lua),
            VALKEYMODULE_SCRIPTING_ENGINE_DEBUGGER_COMMAND("break",
                                                           1,
                                                           break_params,
                                                           1,
                                                           "Add/Remove a breakpoint to the specified line. If no "
                                                           "[line] is specified, it shows all breakpoints. "
                                                           "When line = 0, it removes all breakpoints.",
                                                           0,
                                                           breakCommandHandler),
            VALKEYMODULE_SCRIPTING_ENGINE_DEBUGGER_COMMAND_WITH_CTX("trace",
                                                                    1,
                                                                    NULL,
                                                                    0,
                                                                    "Show a backtrace.",
                                                                    ...
                                                                    traceCommandHandler,
                                                                    lua),
            VALKEYMODULE_SCRIPTING_ENGINE_DEBUGGER_COMMAND_WITH_CTX("eval",
                                                                    1,
                                                                    eval_params,
                                                                    1,
                                                                    ...
                                                                    evalCommandHandler,
                                                                    lua),
            VALKEYMODULE_SCRIPTING_ENGINE_DEBUGGER_COMMAND_WITH_CTX("valkey",
                                                                    1,
                                                                    valkey_params,
                                                                    1,
                                                                    "Execute a command.",
                                                                    ...
                                                                    lua),
            VALKEYMODULE_SCRIPTING_ENGINE_DEBUGGER_COMMAND_WITH_CTX("redis",
                                                                    1,
                                                                    valkey_params,
                                                                    1,
                                                                    NULL,
                                                                    ...
                                                                    valkeyCommandHandler,
                                                                    lua),
            VALKEYMODULE_SCRIPTING_ENGINE_DEBUGGER_COMMAND_WITH_CTX(SERVER_API_NAME,
                                                                    0,
                                                                    valkey_params,
                                                                    1,
                                                                    NULL,
                                                                    ...
                                                                    valkeyCommandHandler,
                                                                    lua),
            VALKEYMODULE_SCRIPTING_ENGINE_DEBUGGER_COMMAND_WITH_CTX("abort",
                                                                    1,
                                                                    NULL,
                                                                    0,
                                                                    "Stop the execution of the script. In sync mode "
        ...
        commands_array_cache = ValkeyModule_Calloc(commands_array_len,
                                                   sizeof(ValkeyModuleScriptingEngineDebuggerCommand));
